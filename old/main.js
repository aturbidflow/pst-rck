	...
	$('#runbtn').click(function(e){
		...
		$.ajax({
			...
			success: function(html) { 
				...
				$('#vk_share').html(VK.Share.button({image: "http://cs309925.userapi.com/v309925164/138e/80-YdjSDi1w.jpg", title: html, description: "HOPE",noparse: true},{type: "button", text: "Поделиться"}));
				$('#twitter-wjs').remove();
